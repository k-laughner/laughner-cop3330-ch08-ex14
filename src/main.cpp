...
int main() {
  ...
  int result = 5;
  std::cout << "\n\nDemonstration\n\n";
  std::cout << "Integer named result with a value of 5 is passed as a constant through a print function.\nA commented out line attempted to change the result to 2. \nBecause the function is pass-by-const, attempting to change the result results in a compile error. \nThis proves how pass-by-const prevents a value from being changed in a function.\n";
  print p;
